...
try:
    ...
    if x == "" or x.lower() == "y":
        os.system(f"{sys.executable} -m pip install humanize --user")
        import humanize
    else:
        print("Unable to continue without humanize")
        sys.exit(1)
...
try:
    ...
    if x == "" or x.lower() == "y":
        os.system(f"{sys.executable} -m pip install psutil --user")
        import psutil
    else:
        print("Unable to continue without psutil")
        sys.exit(1)
